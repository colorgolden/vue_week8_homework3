<template>
    <div class="position-relative">
      ...
      background-position: center center;"><img class="w-100" src="../assets/img/main_image.png" alt=""></div>
    ...
    <div class="row">
      <div class="col-lg-4 my-auto">
        <h2 class="px-5 ms-5 font-monospace" style="letter-spacing: 0.2em">自然 靜心</h2>
        <p class="lead px-5 ms-5 lh-lg">探索身心靈的和諧，踏上一段充滿能量的旅程。我們是一座療癒之地，一個與自然融為一體的綠洲。在這裡，每個瞬間都是與靈魂的自我對話，來到這裡，給您身心靈的一個放鬆、恢復活力的空間。
